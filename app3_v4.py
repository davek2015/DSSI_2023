# Orig Author: Prakash Sukhwal (Aug 2021)
# Amended by: Kwek Tian Ong Dave (A0249261A)
# Date: 11 June 2023
...
# For localhost streamlit and when using with Ngrok 
# load the model.pkl

#path = r'C:\Users\dk\OneDrive\NUS-ISS\DSSI\Day2\code base\DSSI_app3-main\model.pkl'
#with open(path, "rb") as f:
#	model = pickle.load(f)

# for Github with Streamlit community
...
def main():
	# -- Set page config
	apptitle = 'DSSI Day 2 Assignment'
